  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contacto">
      ...
      <h1 className="heading lg:max-w-[45vw]">
          ¿Estás listo para hacer realidad{" "}
          <span className="text-purple">tu proyecto</span>?
        </h1>
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Contacta conmigo y agendamos una reunión para analizar tu proyecto.
        </p>
        <a href="mailto:adrian@aracovita.com">
          <MagicButton
            title="Contacta ya, no seas tímido..."
